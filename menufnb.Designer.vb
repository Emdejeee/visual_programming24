...
Partial Class menufnb
    ...
    Private Sub InitializeComponent()
        ...
        tbharga = New TextBox()
        tbnmmenu = New TextBox()
        tbidmenu = New TextBox()
        Label5 = New Label()
        Label4 = New Label()
        Label3 = New Label()
        Label2 = New Label()
        ...
        Panel1.Controls.Add(tbnmmenu)
        Panel1.Controls.Add(tbidmenu)
        ...
        btnbersih.Image = My.Resources.Resources.icons8_clean_25
        btnbersih.Location = New Point(128, 414)
        ...
        btndel.Image = My.Resources.Resources.icons8_delete_25
        btndel.Location = New Point(232, 358)
        btndel.Name = "btndel"
        ...
        btnedit.Image = My.Resources.Resources.icons8_edit_25
        btnedit.Location = New Point(128, 358)
        ...
        btnsimpan.Image = My.Resources.Resources.icons8_save_20
        btnsimpan.Location = New Point(24, 358)
        ...
        cbjenis.Items.AddRange(New Object() {"Appetizer", "Makanan", "Minuman", "Dessert"})
        cbjenis.Location = New Point(176, 248)
        cbjenis.Name = "cbjenis"
        cbjenis.Size = New Size(125, 28)
        cbjenis.TabIndex = 9
        ' 
        ' tbharga
        ' 
        tbharga.Location = New Point(176, 299)
        ...
        ' tbnmmenu
        ' 
        tbnmmenu.Location = New Point(176, 197)
        tbnmmenu.Name = "tbnmmenu"
        tbnmmenu.Size = New Size(125, 27)
        tbnmmenu.TabIndex = 6
        ' 
        ' tbidmenu
        ' 
        tbidmenu.Location = New Point(176, 146)
        tbidmenu.Name = "tbidmenu"
        tbidmenu.Size = New Size(125, 27)
        tbidmenu.TabIndex = 5
        ' 
        ' Label5
        ' 
        ...
        btnprint.Image = My.Resources.Resources.icons8_print_30
        ...
        btncari.Image = My.Resources.Resources.icons8_search_25
        btncari.Location = New Point(404, 58)
        ...
        ' tbcari
        ' 
        tbcari.Location = New Point(224, 64)
        tbcari.Name = "tbcari"
        tbcari.Size = New Size(163, 27)
        tbcari.TabIndex = 14
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(109, 67)
        Label7.Name = "Label7"
        Label7.Size = New Size(95, 20)
        Label7.TabIndex = 2
        Label7.Text = "Cari Menu"
        ' 
        ' DataGridView1
        ' 
        ...
        Label6.Location = New Point(247, 18)
        Label6.Name = "Label6"
        Label6.Size = New Size(119, 25)
        Label6.TabIndex = 0
        Label6.Text = "View Menu"
        ' 
        ' btnkembali
        ' 
        ...
        btnkembali.Image = My.Resources.Resources.icons8_back_50
    ...
    Friend WithEvents tbidmenu As TextBox
    Friend WithEvents tbharga As TextBox
    Friend WithEvents tbnmmenu As TextBox
